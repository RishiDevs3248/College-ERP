              ...
              <div className="flex flex-col justify-center">
                <div className="w-48">
                  ...
                  <div className="flex justify-center">
                    <NavLink to={"/Login"} className="text-sky-500 mt-8 text-sm underline">Go to Teachers Login Page</NavLink>
                  </div>
                </div>
              </div>
            </div>
            <div className="w-full">
              <img src="./images/stuLoginImg.png" alt="" className="max-h-96 h-96 rounded-tr-2xl rounded-br-2xl	" />
            </div>
