    ...
    return (
        <div className="flex justify-center">
            ...
            <div className="pb-2 mb-5 flex justify-center border-b-2 border-black">BALEWADI PUNE</div>
                ...
                {/* <div><img src={profileData.profilePhoto} alt="" /></div> ------------------------ */}
                <div className=" mt-2 pb-2 mb-2 flex justify-center border-b-2 border-black " > <b>{profileData.name}</b></div>
                <div className="mb-2">Email : {profileData.email}</div>
                <div className="mb-2">Phone No : {profileData.phoneNo}</div>
                <div className="mb-2">Department : {profileData.dept}</div>
            </div>
        </div>
    );
}
